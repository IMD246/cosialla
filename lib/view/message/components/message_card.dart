...
// import 'package:social_ui_kit/view/message/components/audio_message.dart';
// import 'package:social_ui_kit/view/message/components/image_message.dart';
// import 'package:social_ui_kit/view/message/components/like_message.dart';
// import 'package:social_ui_kit/view/message/components/message_status_dot.dart';
// import 'package:social_ui_kit/view/message/components/text_message.dart';
...
//   int count = 0;
//   String handleListUserIDChat() {
//     widget.chat.listUser.forEach(
//       (element) {
//         if (element == widget.ownerUserProfile.id) {
//           if (count >= 2) {
//             return;
//           }
//           count++;
...
//     );
//     if (count >= 2) {
//       return widget.ownerUserProfile.id;
//     } else {
//       return widget.chat.listUser
//           .where(
//             (element) => element != widget.ownerUserProfile.id,
//           )
//           .first;
//     }
//   }
...
//     userIDFriend = handleListUserIDChat();
//     widget.index <= 0
...
//           );
//     if (widget.ownerUserProfile.id != userIDFriend) {
...
//       switch (chatMessage.typeMessage) {
